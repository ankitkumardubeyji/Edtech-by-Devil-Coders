...
const About=()=>{
    return(
        <>
         <h1 className=' fw-bolder 'style={{fontSize:"50px"}}>About Us</h1>
        <div className="mb-5">
            <div className="m-4">
            <p className="content">
            ...
            <h4 className="thank mx-5 ">Thank you for choosing <span>[Course Name]</span>. Get ready to embark on an exciting learning journey with us!</h4>
        </div>
